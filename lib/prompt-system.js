...
const MODULE_TEMPLATES = {
  ...
  'DE4 Climate': {
    fullName: "Design Engineering for Climate",
    domainKnowledge: [
    ...
    tacitMarkers: [
      ...
      "community insights",
      "behavioral change understanding",
      "systemic thinking",
  ...
  'DE4 Bio': {
    fullName: "Biomedical Design Engineering",
    domainKnowledge: [
  ...
  'DE4 Digital': {
    fullName: "Digital Design Engineering",
    domainKnowledge: [
...
const ANALYSIS_STRATEGIES = {
  ...
  final: {
    ...
    - Clearly distinguish between explicit and tacit knowledge
...
class PromptBuilder {
  constructor(config = {}) {
    ...
    this.module = config.module || 'DE4 ERO';
    this.meetingType = config.meetingType || 'brainstorming';
    this.goals = config.goals || '';
    this.teamMembers = config.teamMembers || [];
    this.analysisType = config.analysisType || 'final'; // 'intermediate' or 'final'

...
'General': {
    fullName: "General Purpose Meeting",
    moduleContext: `General module for testing and basic meeting analysis. Suitable for any type of team discussion or collaborative session without specific module requirements.`,
...
const MEETING_TYPE_TEMPLATES = {
  ...
  'problem-solving': {
    ...
    'one-on-one': {
    processFocus: "Individual conversation and personalized feedback",
    analysisFramework: {
      trackingPoints: [
        "Personal goals and challenges discussed",
    ...
    promptGuidance: `Focus on individual development:
    - Personal goals and aspirations
    - Specific feedback and guidance
    - Individual challenges and blockers
    - Skills development opportunities
    - Concrete next steps and accountability`
  }
};
...
const ANALYSIS_STRATEGIES = {
  ...
  realtime: {
    ...
    - For each New decision, extract supporting EXPLICIT and TACIT knowledge
